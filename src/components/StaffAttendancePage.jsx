...
import { Plus, Users, Filter, RotateCcw, ArrowLeft, CheckCircle2 } from "lucide-react";
        ...
        return (
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <h1 className="text-2xl font-bold text-gray-800">Mark Staff Attendance</h1>
                    <Button
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    <form className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-gray-600 uppercase">Attendance Date <span className="text-red-500">*</span></label>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea className="w-full h-32 rounded-xl border border-gray-200 p-4 text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-gray-50/50 resize-none" placeholder="Enter any remarks..." />
                        </div>
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button className="bg-[#1e463a] hover:bg-[#153229] text-white px-6 py-2 rounded-lg flex items-center gap-2 border-none">
                        <Users size={18} />
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50/50 hover:bg-gray-50/50 border-b border-gray-200">
                                ...
                                <TableHead className="font-bold text-gray-800 text-xs uppercase py-5">Attendance Date</TableHead>
                                <TableHead className="font-bold text-gray-800 text-xs uppercase py-5">Status</TableHead>
                                <TableHead className="font-bold text-gray-800 text-xs uppercase py-5">Remarks</TableHead>
                                <TableHead className="font-bold text-gray-800 text-xs uppercase py-5">Marked By</TableHead>
                        ...
                        <TableBody>
                            <TableRow>
                                <TableCell colSpan={8} className="py-20 text-center text-gray-400 font-medium">
