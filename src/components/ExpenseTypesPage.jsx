...
import { Plus, Search, RotateCcw, ArrowLeft, MoreVertical } from "lucide-react";
        ...
        return (
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <h1 className="text-2xl font-bold text-gray-800">Add Expense Type</h1>
                    <Button
                    ...
                    <form className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input placeholder="Enter Expense Type" required className="h-11 rounded-xl" />
                            </div>
                            <div className="space-y-2">
