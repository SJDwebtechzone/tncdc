...
import { Plus, Search, RotateCcw, MoreVertical } from "lucide-react";
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-md rounded-sm shadow-2xl relative">
                        <div className="flex items-center justify-between p-4 border-b">
                            <h2 className="text-sm font-normal text-gray-800">Add New Expense Type</h2>
                        ...
                        <form className="p-6 space-y-6">
                            <div className="space-y-1">
                                ...
                                <Input placeholder="Enter Expense Type" className="h-9 rounded-sm border-gray-200 text-xs" />
                            </div>

                            <div className="flex justify-center gap-3 pt-2">
                                <Button type="button" onClick={() => setIsModalOpen(false)} className="bg-[#b45309] hover:bg-[#8e420b] text-white border-none h-9 text-xs font-bold px-12 rounded-sm">
                                    Cancel
                                </Button>
                                <Button type="submit" className="bg-[#1e463a] hover:bg-[#153229] text-white h-9 text-xs font-bold px-12 rounded-sm">
                                    Add Expense Type
                                </Button>
                            </div>
                        </form>
